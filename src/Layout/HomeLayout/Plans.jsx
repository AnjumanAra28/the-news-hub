...
const Plans = () => {
  ...
  return (
    <div className="w-11/12 mx-auto my-14">
        <SectionTitle heading={'Choose Your Plan'} subHeading={'Be A Member'}></SectionTitle>

      <div className="grid md:grid-cols-2 gap-6">
        {/* Free Plan */}
        <div className="border border-gray-300 p-6 rounded-lg shadow-md bg-white">
          <h3 className="text-2xl font-semibold mb-3"><IoIosPaperPlane /> Free Plan</h3>
        ...
        <div className="border border-orange-500 p-6 rounded-lg shadow-md bg-white">
          ...
          <button
            ...
            className="btn btn-outline border-orange-500 text-orange-500 w-full hover:bg-orange-500 hover:text-white"
          >
            Subscribe Now
          </button>
        </div>
